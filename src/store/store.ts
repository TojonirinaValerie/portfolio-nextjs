...
type StoreActionType = {
  ...
  setContactRef: (value: RefObject<HTMLDivElement | null>) => void;
  setProjectRef: (value: RefObject<HTMLDivElement | null>) => void;
};
const useAppStore = create<StoreType & StoreActionType>((set) => ({
  aboutRef: null,
  projectRef: null,
  contactRef: null,
  setAboutRef: (ref: RefObject<HTMLDivElement | null>) =>
    set({ aboutRef: ref }),
  setContactRef: (ref: RefObject<HTMLDivElement | null>) =>
    set({ contactRef: ref }),
