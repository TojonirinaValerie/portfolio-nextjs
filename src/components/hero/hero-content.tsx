...
const HeroContent = () => {
  return (
    <main className=" text-white flex flex-col items-center justify-center h-full w-full border">
      <div className="flex flex-row gap-2 px-12 w-full max-w-[1200px]">
        {/* <div className="flex flex-col flex-1 items-center">
          <h1 className="text-lg text-center">
            Bonjour, je suis{" "}
            <span className="text-red text-xl font-bold">Tojonirina</span>
          </h1>
          <h1 className="text-6xl text-[600] text-center">
            Développeur <span className="text-red">Fullstack</span>
          </h1>
          <p className="text-base mt-6 max-w-[600px] text-gray-300 text-center">
            Passionné par l&apos;univers numérique et les nouvelles
            technologies, je réalise des applications robustes et évolutives
          </p>
          <Button variant="destructive">Contacter</Button>
        </div> */}
